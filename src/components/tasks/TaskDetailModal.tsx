...
function MomentChipHalf({ icon, muted, children }: MomentChipHalfProps) {
  return (
    <span className={clsx('inline-flex items-center gap-1', muted && 'opacity-50')}>
      {icon}
      <span
        className={clsx(
          'font-mono',
    ...
    >
      <div className="space-y-4">
        <div className="flex flex-col gap-1">
          {currentFieldName && (
            <span className="text-teal-400 text-[10px] font-bold tracking-wide uppercase">
              {currentFieldName}
            </span>
          )}
        ...
        <div className="[&>*+*]:border-ink-700 grid grid-cols-1 gap-2.5 [&>*+*]:mt-1 [&>*+*]:border-t [&>*+*]:pt-3.5 sm:grid-cols-2 sm:gap-5 sm:[&>*+*]:mt-0 sm:[&>*+*]:border-t-0 sm:[&>*+*]:pt-0">
          <div className="min-w-0">
            ...
            <div
              className={clsx(
                'inline-flex h-[34px] w-fit items-center gap-1.5 rounded-md border px-2.5 font-mono text-xs',
          ...
          <div className="min-w-0">
            ...
            <div className="space-y-2">
              {moments.map((moment) => {
                ...
                return (
                  <div key={moment.id} className="group flex items-start gap-1.5">
