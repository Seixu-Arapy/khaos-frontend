    ...
    <>
      <form onSubmit={handleSubmit} className="relative max-w-xl flex-1">
        ...
        <input
          ...
          className="border-ink-700 bg-ink-800 text-ink-100 placeholder:text-ink-500 focus:border-copper-400 w-full rounded-full border py-2 pr-3 pl-9 text-body focus:outline-hidden"
        />
      </form>
        ...
        {draft && (
          <div className="space-y-3">
            ...
            {!sectionsForProject.length && draft.projectId && (
              <p className="text-rust-500 text-caption">
