      ...
      >
        <div className="border-ink-700 flex items-center gap-2 border-b px-4 py-3">
          ...
          <input
            ...
            className="text-ink-100 placeholder:text-ink-500 flex-1 bg-transparent text-body focus:outline-hidden"
          />
        </div>
        <div className="max-h-80 overflow-y-auto py-1.5">
          {results.map((item) => (
            <button
              ...
              onClick={() => go(item)}
              className="text-ink-200 hover:bg-ink-700 flex w-full items-center justify-between gap-2 px-4 py-2 text-left text-body"
            >
              <span className="flex min-w-0 flex-col items-start gap-0.5">
                {item.type === 'project' ? (
                  <ProjectChip
                    ...
                    className="text-ink-200 text-body"
                  />
                ) : (
                  <>
              ...
              <span className="flex shrink-0 items-center gap-2">
                <span className="text-ink-600 text-caption tracking-wide uppercase">
                  {item.type}
                </span>
          ...
          {!results.length && (
            <p className="text-ink-600 px-4 py-6 text-center text-body">
              Nothing found
            </p>
          )}
        </div>
